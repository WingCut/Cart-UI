  ...
  return (
    <SingleCourseWrapper>
        ...
        <div className="course_details">
          ...
          <div className="course-body">
            ...
            <div className="course-rating flex">
              ...
              <span className="rating-count fw-5 fs-4">({rating_count})</span>
              <span className="students-count fs-14">{students}</span>
            </div>
            <ul className="course-info">
              <li>
                <span className="fs-14">
                  Create by<span className="fw-6 opacity-08">{creator}</span>
                </span>
              </li>
              <li className="flex">
                <span>
      ...
      <div className="course-full bg-white text-dark">
        <div className="course-learn ms-auto">
        ...
        <div className="course-content ms-auto">
